# IBM Video Streaming Player SDK for tvOS v1.4
...
This document describes the basic steps to make a mobile app using the Player SDK for tvOS.
...
```objc
USMediaDescriptor *mediaDescriptor = [USMediaDescriptor liveDescriptorWithID:<#place your channel ID here#>];
