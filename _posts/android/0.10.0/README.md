# IBM Video Streaming Player SDK for Android v0.10
...
Ustream Player SDK version 0.10.0 introduced changes in the user facing interface, see the [CHANGELOG.md] for details.
