# IBM Video Streaming Player SDK for Android v1.0
...
IBM Video Streaming Player SDK version 1.0.0 introduced changes in the user facing interface, see the [CHANGELOG.md] for details.
